          ...
          <form className="create" id="create" autoComplete="off">
            ...
            <div className={editeErrorProduct.picture ? "leftbtn imageErrorMessage" : "leftbtn"} id="leftBtn">
              <div id="uppDiv">
                ...
                <input type="file" accept="image/*" name="file" id="file" value={editeProduct.picture!=null || editeProduct.picture!=""?editeProduct.picture:""} style={{ "display": "none" }} onChange={(e) => uploadImageHandler(e)} />
              </div>
